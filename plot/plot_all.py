...
plt.savefig(os.path.join(LISPMON_FIGURES_AND_TABLES, "{0}_{1}_{2}".format(now.year, now.month, now.day), 'eid_eid_prefix_rloc_number.eps'), dpi=300, transparent=True)
plt.show()